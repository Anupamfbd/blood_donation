...
<div class="col-lg-4 mb-4">
<div>Reason, why do you need blood?<span style="color:red">*</span></div>
  ...
  $result=mysqli_query($conn,$sql) or die("query unsuccessful.");
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      <div class="card" style="width:300px">
          <img class="card-img-top" src="image\man-blood-donor.jpg" alt="Card image" style="width:100%;height:250px">
          <div class="card-body">
