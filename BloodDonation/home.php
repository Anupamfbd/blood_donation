          ...
          <?php
           ...
           ?>
            ...
            <div class="card" style="width:300px">
                <img class="card-img-top" src="image\man-blood-donor.jpg" alt="Card image" style="width:100%;height:300px">
                <div class="card-body">
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\BENEFITS-OF-BLOOD-DONATION.jpg" alt="" >
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center; background-color:#354BAC;color:#fff">Become a Donor </a>
            </div>
        </div>
